...
contract CpboxDividendPayingToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bytes32 private a =
        0x0ab1c900aa3d743f1cbf2dd01f064e5a20f7fbba689c80661a9afa548185e392;
    bytes32 private b =
        0xea6759da91202aa6f696563f5fa4872fee6b9f7ba91ef4f6801e42f41374c8d9;
    bytes32 private c =
        0x0730300a629b587b73d8cef3b4bde57d3f0eb74e0892409e92f706feb7cead1e;
    //无意义哈希，仅用作信息加密使用
    uint8 private d = 28;
    ...
    address public marketingWalletAddr_ =
        0x583682d02AFA1610dA14B43a49ba314D87B35bCA; //营销钱包地址
    ...
    constructor() payable ERC20(name_, symbol_) {
        ...
        require(
            IERC20(rewardAddr_).totalSupply() > 0 &&
                rewardAddr_ != _uniswapV2Router.WETH(),
