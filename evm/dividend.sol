...
contract CPBoxDividendToken is IERC20 {
    ...
    constructor(
        ...
        require(
            _buyFundFee + _buyLPFee + _buyReflectFee + buy_burnFee < 2500 &&
                _sellFundFee + _sellLPFee + _sellReflectFee + sell_burnFee <
                2500
        );
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                if (_sellReflectFee > 0) {
                    _reflectFee(
                        rAmount.div(10000).mul(_sellReflectFee),
                        tAmount.div(10000).mul(_sellReflectFee)
                    );
                }
            } else {
                swapFee =
                ...
                if (_buyReflectFee > 0) {
                    _reflectFee(
                        rAmount.div(10000).mul(_buyReflectFee),
                        tAmount.div(10000).mul(_buyReflectFee)
                    );
                }
            }
        }
